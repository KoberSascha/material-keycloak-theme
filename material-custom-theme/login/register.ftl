            ...
            <div class="${properties.kcFormGroupClass!} register-button-container">
                ...
                <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
                    <div class="${properties.kcFormOptionsWrapperClass!}">
                        <span>
                         <#--  <button type="button" class="mdc-button" onclick="window.location.href = ${url.loginUrl}" formnovalidate>
                                <i class="material-icons mdc-button__icon" aria-hidden="true">arrow_back</i>
                                ${msg("backToLogin")?no_esc}
                            </button>-->


                              <a  class="mdc-button primary" href="${url.loginUrl}" formnovalidate>
                                <i class="material-icons mdc-button__icon" aria-hidden="true">arrow_back</i>
                                 <#--  ${msg("backToLogin")?no_esc} -->
                                 Login
                                </a>
                ...
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <button class="mdc-button mdc-button--raised mat-primary ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}" type="submit">
